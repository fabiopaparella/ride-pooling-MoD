...
for i = 1:N
    for j = RoadGraph{i}
        LinkLength(i,j) = norm(NodesLoc(j,:) - NodesLoc(i,:)); %m
...
G_road=digraph(LinkTime/(60)); %h
FreeFlowTime = G_road.Edges.Weight';
...
save('Graphs.mat', 'G_road','NodesLoc','LinkTime','FreeFlowTime');
